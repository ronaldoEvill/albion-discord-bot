...
# Servidor Flask para mantener vivo el Web Service gratuito en Render
app = Flask("")
...
async def buscar(ctx):
    ...
    if not opportunities:
        await ctx.send(
            "❌ No se encontraron oportunidades de transporte con más de 20,000 de ganancia en este momento."
        )
        return
